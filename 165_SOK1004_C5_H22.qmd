...
# årene som ble printet ut i koden over
  geom_segment(aes(x=1,xend=10,y=avg96_05[1,12],yend=avg96_05[1,12]), linewidth=0.8) +
  geom_segment(aes(x=11,xend=18,y=avg05_13[1,12],yend=avg05_13[1,12]), linewidth=0.8) + 
  geom_segment(aes(x=11,xend=26,y=avg06_21[1,12],yend=avg06_21[1,12]), linewidth=0.8) +
