...
figur_2 <- figur_1+
  ...
  geom_segment(aes(x=4250,xend=4250,y=0,yend=5100), size=0.1, linetype="dashed") + 
  geom_segment(aes(x=0,xend=4250,y=5100,yend=5100), size=0.1, linetype="dashed")
...
Laster inn datasettet Konsumprisindeks med hovedgruppenivå matvarer og alkoholfrie drikkevarer (03013) fra SSB, dette er ikke relevant for utskrift.
...
theme(plot.title = element_text(size = 15))+
  labs(title="Matvarer og alkoholfrie drikkevarer", subtitle="År er plottet med måneder",
       caption="Basert på tabell 03013 fra SSB") +
  scale_y_continuous(breaks=seq(115,140, by=5))+
  
# Siden theme_fivethirtyeight har fjernet titler til aksene må jeg legge de
# inn igjen i theme
theme(axis.title = element_text(), legend.text = element_text(size=8)) + 
ylab("Vekter(promille)") + 
xlab ("År")
```
...
Laster inn datasettet Forbrukerundersøkelsen med hovedgruppenivå matvarer og alkoholfrie drikkevarer (10235) fra SSB, dette er ikke relevant for utskrift.
...
```{r}
# Begynner plottet, setter x-verdien til år og y-verdien til value
# Setter gruppe til statistikkvariabel slik at den trekker linjer mellom FBU og KPI
# Har color til statistikkvariabel for å skille disse to seriene med farge
