...
title-block-banner: "darkblueslate"
format:
  html: 
    code-fold: true
    df-print: kable
...
df %>%
  ...
  scale_x_continuous(limits=c(1850, 2020),
                              expand=c(0,0))+
  labs(title= "Karbonintensiteten til de fem største økonomiene", y="Kg CO2 utslipp per dollar av BNP", color="Land", x="")+
